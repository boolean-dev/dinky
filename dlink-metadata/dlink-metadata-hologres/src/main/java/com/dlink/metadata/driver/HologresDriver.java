...
import com.dlink.metadata.convert.HologresTypeConvert;
import com.dlink.metadata.convert.ITypeConvert;
import com.dlink.metadata.query.HologresQuery;
...
/**
 * @className: HologresDriver
 * @description: hologres driver
 * @author: Jiantao Yan
 * @date: 2022-11-8 16:08
 **/
public class HologresDriver extends AbstractJdbcDriver {
    ...
    public IDBQuery getDBQuery() {
        return new HologresQuery();
    }

    @Override
    public ITypeConvert getTypeConvert() {
        return new HologresTypeConvert();
    }
